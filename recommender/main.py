...
#{"recommend":"CONTENT", "max":5, "missions":["5345ce62744e47ff0b4ed89a", "54449b97e4b08d74189d0afe", "544499dae4b08d74189d003b"]}
...
def content_recommend(message_object):
    ...
    for mission_id in message_object['missions']:
        ...
        try:
            ...
            results=recommenders[mission_id].make_recommend(top=message_object['max'], end_time=end_time)
